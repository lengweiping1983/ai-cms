 ...
 */
@Entity
@Table(name = "epg_content_series")
public class Series extends AbstractEntity {
	private static final long serialVersionUID = 1L;

	public final static String SERIES_CODE_PREFIX = "";
	...
	public static final String METADATA = "contentType,title,searchName,language,caption,directors,directorsPinyin,actors,actorsPinyin,comperes,guests,genres,year,"
			...
			+ "episodeTotal,type,cpId,broadcastLicense,internalTag,reserved1,reserved2";
	public static final String STAGE = "stageImages";
	public static final String POSTER = "image1,image2";
	public static final String METADATA_OTHER = "orderNumber,originalName,sortName,kpeople,scriptWriter,reporter,incharge,mediaId,mediaCode,"
