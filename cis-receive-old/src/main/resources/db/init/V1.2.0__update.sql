...
-- csp_id,lsp_id 填对应提供商代码，值填一样的,service_url填福建广电cms分发通知接口地址
-- 芒果代码为MGTV
-- 本地开发环境
...
-- 174演示环境
update cms_injection_platform set csp_id='MGTV',lsp_id='MGTV',service_url='http://115.231.111.174/cissend/services/ctms?wsdl' where id=2;


-- 结果通知
-- http://115.231.111.174/cissend/services/ctms?wsdl

-- 发送到新的测试
-- http://115.231.111.174/cisreceive/services/ctms?wsdl

-- 发送到老的芒果专区
-- http://115.231.111.174/cisreceiveold/services/ctms?wsdl
