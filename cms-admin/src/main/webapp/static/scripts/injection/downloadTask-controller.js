$(function () {
    $.DownloadTaskController = function (elm, config) {

    }

    $.extend(true, $.DownloadTaskController, $.BaseController, {

    	init: function (prefix) {
    		$.DownloadTaskController.initTimepicker();
    		
        	$.DownloadTaskController.initTableCheckBox(prefix);
        },
        ...
        toDelete: function (path, name) {
            ...
            json.event = "$.DownloadTaskController._delete('" + path + "')";
        ...
        detail: function (id) {
            $.common.showModal({
                url: contextPath + "/injection/downloadTask/" + id + "/detail",
                success: function () {
        ...
        toSend: function (path, name, methodDesc) {
            ...
            json.event = "$.DownloadTaskController.send('" + path + "')";
            $.common.showConfirmModal(json);
        },
        ...
        batchTo: function (path, itemType) {
            var itemIds = $.DownloadTaskController.getItemIds();
        ...
        toBatchChangeStatus: function (path, itemType, desc) {
            ...
            json.event = "$.DownloadTaskController.batchChangeStatus('" + path + "'," + itemType + ",'" + desc + "')";
            $.common.showConfirmModal(json);
        },
        
        batchChangeStatus: function (path, itemType, desc) {
        	var itemIds = $.DownloadTaskController.getItemIdsString();
