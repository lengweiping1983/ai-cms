$(function () {
    $.WidgetItemController = function (elm, config) {

    }

    $.extend(true, $.WidgetItemController, $.BaseController, {
        ...
        toEdit: function (path, id) {
            ...
            $.common.showModal({
                ...
                success: function () {
                	...
                	$.WidgetItemController.onloadUriConfig();
                },
            });
        },
        ...
        edit: function (path) {
            ...
            json.groupCodes = $.WidgetItemController.getGroupCodes();
        ...
        toDelete: function (path, name) {
            ...
            json.event = "$.WidgetItemController._delete('" + path + "')";
        ...
        toChangeStatus: function (path, name, statusMethodDesc) {
            ...
            json.event = "$.WidgetItemController.changeStatus('" + path + "')";
            $.common.showConfirmModal(json);
        },
