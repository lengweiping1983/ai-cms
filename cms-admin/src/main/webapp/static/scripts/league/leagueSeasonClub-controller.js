$(function () {
    $.LeagueSeasonClubController = function (elm, config) {

    }

    $.extend($.LeagueSeasonClubController, {
        ...
        toDelete: function (path, name) {
            ...
            json.event = "$.LeagueSeasonClubController._delete('" + path + "')";
        ...
        toChangeStatus: function (path, name, statusMethodDesc) {
            ...
            json.event = "$.LeagueSeasonClubController.changeStatus('" + path + "')";
            $.common.showConfirmModal(json);
        },
