$(function () {
    $.LeagueSeasonMatchController = function (elm, config) {

    }

    $.extend($.LeagueSeasonMatchController, {
        ...
        toDelete: function (path, name) {
            ...
            json.event = "$.LeagueSeasonMatchController._delete('" + path + "')";
        ...
        toMove: function (path, name) {
            var json = {};
            json.title = "移走操作";
            json.body = "您确认要移走[" + name + "]吗?";
            json.event = "$.LeagueSeasonMatchController.move('" + path + "')";
            $.common.showConfirmModal(json);
        },
        ...
        toChangeStatus: function (path, name, statusMethodDesc) {
            ...
            json.event = "$.LeagueSeasonMatchController.changeStatus('" + path + "')";
            $.common.showConfirmModal(json);
        },
