$(function () {
    $.MediaTemplateController = function (elm, config) {

    }

    $.extend(true, $.MediaTemplateController, $.BaseController, {
            ...
            $.common.showModal({
                ...
                success: function () {
                    $.extend($.validationEngineLanguage.allRules, {
                        "ajaxCodeCheck": {
                            "url": contextPath + "/config/mediaTemplate/check?id=" + id,
        ...
        toDelete: function (path, name) {
            ...
            json.event = "$.MediaTemplateController._delete('" + path + "')";
