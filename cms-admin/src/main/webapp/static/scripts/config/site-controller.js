$(function () {
    $.SiteController = function (elm, config) {

    }

    $.extend(true, $.SiteController, $.BaseController, {
            ...
            $.common.showModal({
                ...
                success: function () {
                    $.extend($.validationEngineLanguage.allRules, {
                        "ajaxCodeCheck": {
                            "url": contextPath + "/config/site/check?id=" + id,
        ...
        toDelete: function (path, name) {
            ...
            json.event = "$.SiteController._delete('" + path + "')";
