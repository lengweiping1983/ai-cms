...
<div class="table-container">
	<div class="table-actions-wrapper-condition">
		<form action="${ctx}/star/star/selectItem" id="selectItem">
			...
			<c:forEach items="${page.content}" var="t">
				<tr>
					...
					<td><a href="javascript:;"
						onclick="$.StarController.selectItem('${param.selectMode}','${t.id}','${t.name}','${t.name}','${t.image1}','${t.image2}','${t.status}');">${t.name}</a></td>
					<td>${t.tag}</td>
