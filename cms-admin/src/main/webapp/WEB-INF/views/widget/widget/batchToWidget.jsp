	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">批量编排到推荐位</h4>
			</div>
			<div class="modal-body">
				<form id="editForm">
					...
					<div class="content form-horizontal">
						...
						<div class="form-group">
							<label class="control-label col-md-4">所属推荐位(<span
								class="required">*</span>):
							</label>

							<div class="col-md-6">
								<div class="input-group">
									<input type="hidden" name="selectWidgetId" id="selectWidgetId" />
									<input type="text" class="form-control validate[required]"
										name="selectWidgetName" id="selectWidgetName"
										placeholder="点击我选择所属推荐位" readonly="readonly"
										onclick="$.WidgetController.toSelectWidget();" /> <span
										class="input-group-btn">
										<button onclick="$.WidgetController.toSelectWidget();"
			...
			<div class="modal-footer">
				<button class="btn btn-outline green"
					onclick="$.WidgetController.batchToWidget('${ctx}/widget/widget/batchToWidget');">
