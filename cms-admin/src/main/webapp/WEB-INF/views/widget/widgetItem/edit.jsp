		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">
					<c:choose>
						<c:when test="${empty widgetItem.id}">
			...
			<div class="modal-body">
				...
				<form id="editForm">
					<input type="hidden" id="internalParam" name="internalParam" value="${widgetItem.internalParam}" />
					<input type="hidden" id="internalParamCategory" name="internalParamCategory" value="${widgetItem.internalParamCategory}" />
					<input type="hidden" name="id" value="${widgetItem.id}" /> <input
						type="hidden" name="widgetId" value="${widget.id}" /> <input
						type="hidden" name="itemId" id="itemId"
						value="${widgetItem.itemId}" onchange="$.WidgetItemController.changeItemIdValue();"/>
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<select id="itemType" name="itemType" class="form-control"
													onchange="$.WidgetItemController.changeSelectItem();">
													<c:forEach var="item" items="${typeEnum}">
														...
														<option value="${item.key}"
															<c:if test="${item.key eq widgetItem.itemType}"> selected="selected" </c:if>>${item.value}</option>
														</c:if>
													</c:forEach>
												</select>
											</div>
											...
											<div class="col-md-9">
												<div class="input-group">
													<input type="text" class="form-control validate[required]"
														...
														readonly="readonly"
														onclick="$.WidgetItemController.toSelectItem();" /> <span
														class="input-group-btn">
														<button onclick="$.WidgetItemController.toSelectItem();"
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" id="itemTitle"
													value="${widgetItemView.itemTitle}" readonly="readonly"
													class="form-control">
											</div>
										</div>
									</div>
											...
											<div class="col-md-9">
												<select id="itemStatus" name="itemStatus"
													...
													<c:forEach var="item" items="${statusEnum}">
														<option value="${item.key}"
															<c:if test="${! empty widgetItemView.itemStatus && item.key eq widgetItemView.itemStatus}"> selected="selected" </c:if>>${item.value}</option>
													</c:forEach>
												</select>
											</div>
										</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" value="${widgetItemView.itemName}"
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" value="${widgetItemView.itemTitle}"
													readonly="readonly" class="form-control">
											</div>
										</div>
									</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" name="title" value="${widgetItem.title}"
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<select name="status" class="form-control">
											<c:forEach var="item" items="${statusEnum}">
												<option value="${item.key}"
													<c:if test="${! empty widgetItem.status && item.key eq widgetItem.status}"> selected="selected" </c:if>>${item.value}</option>
											</c:forEach>
										</select>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" name="sortIndex"
											value="${widgetItem.sortIndex}"
											class="form-control validate[required,custom[integer]]"
											placeholder="请输入排序值" />
										<c:if test="${empty widgetItem.id}">
									...
									<div class="col-md-9">
										<select id="jumpType" name="jumpType" class="form-control">
											<c:forEach var="item" items="${jumpTypeEnum}">
												<option value="${item.key}"
													<c:if test="${item.key eq widgetItem.jumpType}"> selected="selected" </c:if>>${item.value}</option>
											</c:forEach>
										</select>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-md-9">
										<select id="jumpItemType" name="jumpItemType" class="form-control"
											onchange="$.WidgetItemController.changeSelectJumpItem();">
											<c:forEach var="item" items="${widgetJumpItemTypeEnum}">
												<option value="${item.key}"
													<c:if test="${item.key eq widgetItem.jumpItemType}"> selected="selected" </c:if>>${item.value}</option>
											</c:forEach>
										</select>
									</div>
								</div>
							</div>
							<div id="jump_item_id" <c:if test="${empty widgetItem.jumpItemType || widgetItem.jumpItemType eq 0 || widgetItem.jumpItemType eq 99}"> style="display: none" </c:if>>
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-9">
											<div class="input-group">
												<input type="hidden" name="jumpItemId" id="jumpItemId" value="${widgetItem.jumpItemId}" />
												<input type="text" class="form-control validate[required]"
													name="jumpItemName" id="jumpItemName"  value="${jumpItemName}" placeholder="点击我选择元素"
													readonly="readonly"
													onclick="$.WidgetItemController.toSelectJumpItem();" /> <span
													class="input-group-btn">
													<button onclick="$.WidgetItemController.toSelectJumpItem();"
														class="btn btn-success" type="button">
														<i class="fa fa-arrow-left fa-fw" /></i> 选择元素
													</button>
												</span>
							...
							<div id="uri_url" <c:if test="${empty widgetItem.jumpItemType || widgetItem.jumpItemType eq 0 || widgetItem.jumpItemType ne 99}"> style="display: none" </c:if>>
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="url" value="${widgetItem.url}"
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" id="jumpParam1" name="jumpParam1"
											value="${widgetItem.jumpParam1}" class="form-control"
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" id="jumpParam2" name="jumpParam2"
											value="${widgetItem.jumpParam2}" class="form-control"
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<div class="col-md-6">
										<c:if test="${empty widgetItemView.itemImage2}">
											<c:set var="imageUrl" value="${ctx}/static/img/no-image.png" />
											<c:set var="fileinputMethod" value="fileinput-new" />
										</c:if>
										<c:if test="${! empty widgetItemView.itemImage2}">
											<c:set var="imageUrl"
												value="${fns:getImagePath(widgetItemView.itemImage2)}" />
											<c:set var="fileinputMethod" value="fileinput-exists" />
										</c:if>
							...
							<div class="col-md-3" <c:if test="${widget.configImage1 != 1}"> style="display: none" </c:if>>
								<div class="form-group">
									<label class="control-label col-md-6">定制横海报: </label>

									<div class="col-md-6">
										<input type="hidden" id="image1" name="image1"
											value="${widgetItem.image1}">

										<c:if test="${empty widgetItem.image1}">
											<c:set var="imageUrl" value="${ctx}/static/img/no-image.png" />
											<c:set var="fileinputMethod" value="fileinput-new" />
										</c:if>
										<c:if test="${! empty widgetItem.image1}">
											<c:set var="imageUrl"
												value="${fns:getImagePath(widgetItem.image1)}" />
											<c:set var="fileinputMethod" value="fileinput-exists" />
										</c:if>
										...
										<div class="clearfix margin-top-10">
											<span class="label label-info">大小${widget.configImage1Width}X${widget.configImage1Height}</span>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-3" <c:if test="${widget.configImage2 != 1}"> style="display: none" </c:if>>
								<div class="form-group">
									<label class="control-label col-md-6">定制竖海报: </label>

									<div class="col-md-6">
										<input type="hidden" id="image2" name="image2"
											value="${widgetItem.image2}">
										<c:if test="${empty widgetItem.image2}">
											<c:set var="imageUrl" value="${ctx}/static/img/no-image.png" />
											<c:set var="fileinputMethod" value="fileinput-new" />
										</c:if>
										<c:if test="${! empty widgetItem.image2}">
											<c:set var="imageUrl"
												value="${fns:getImagePath(widgetItem.image2)}" />
											<c:set var="fileinputMethod" value="fileinput-exists" />
										</c:if>
										...
										<div class="clearfix margin-top-10">
											<span class="label label-info">大小${widget.configImage2Width}X${widget.configImage2Height}</span>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="col-md-9">
										<div class="input-group date form_datetime">
											<input type="text" id="validTime" name="validTime"
												value='<fmt:formatDate value="${widgetItem.validTime}"
									...
									<div class="col-md-9">
										<div class="input-group date form_datetime">
											<input type="text" id="expiredTime" name="expiredTime"
												value='<fmt:formatDate value="${widgetItem.expiredTime}"
                                                                                       pattern="yyyy-MM-dd HH:mm"/>'
												size="16"
												readonly class="form-control validate[required]"> <span
												class="input-group-btn">
									...
									<div class="col-md-9">
										<div class="checkbox-list">
											<c:forEach var="item" items="${subscriberGroupList}">
												...
												<c:forEach var="subscriberGroup" items="${widgetItem.groupCodes}">
					...
					<div class="row">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="hidden" id="backgroundImage"
										name="backgroundImage" value="${widgetItem.backgroundImage}">
	
									<c:if test="${empty widgetItem.backgroundImage}">
										<c:set var="imageUrl" value="${ctx}/static/img/no-image.png" />
										<c:set var="fileinputMethod" value="fileinput-new" />
									</c:if>
									<c:if test="${! empty widgetItem.backgroundImage}">
										<c:set var="imageUrl"
											value="${fns:getImagePath(widgetItem.backgroundImage)}" />
										<c:set var="fileinputMethod" value="fileinput-exists" />
									</c:if>
									<div
						...
						<div class="col-md-6" id="internalParamCategory_div" style="display: none">
							<div class="form-group">
								...
								<div class="col-md-9">
									<select class="form-control" onchange="$.WidgetItemController.changeInternalParamCategory(this.value);">
										<c:forEach var="item" items="${templateParamCategoryEnum}">
											<option value="${item.key}"
												<c:if test="${item.key eq widgetItem.internalParamCategory}"> selected="selected" </c:if>>${item.value}</option>
										</c:forEach>
									</select>
								</div>
							</div>
				...
				<c:choose>
					<c:when test="${empty widgetItem.id}">
						<button class="btn btn-outline green"
							onclick="$.WidgetItemController.edit('${ctx}/widget/${widget.id}/widgetItem/add');">
							<i class="fa fa-save"></i>保存
						</button>
					</c:when>
					<c:otherwise>
						<button class="btn btn-outline green"
							onclick="$.WidgetItemController.edit('${ctx}/widget/${widget.id}/widgetItem/${widgetItem.id}/edit');">
							<i class="fa fa-save"></i>保存
						</button>
					</c:otherwise>
				</c:choose>
