	...
	<div class="modal-dialog modal-full">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">[${widget.name}]批量修改</h4>
			</div>
						...
						<div class="row">
							<div class="col-md-12">
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<c:forEach items="${widgetItemList}" var="t"
											varStatus="status">
											<tr>
			...
			<div class="modal-footer">
				<button class="btn btn-outline green"
					onclick="$.BaseController.batchChangeTitle('${ctx}/widget/${widget.id}/widgetItem/batchChangeTitle');">
