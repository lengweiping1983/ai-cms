		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">
					...
					[${widget.name}]批量${methodDesc}推荐位项
				</h4>
			</div>
								...
								<div class="input-group">
									<select id="itemType" name="itemType" class="form-control">
										<c:forEach var="item" items="${typeEnum}">
											...
											<c:if test="${item.key eq 1 || item.key eq 2 || item.key eq 3 || item.key eq 13}">
										...
										<button onclick="$.WidgetItemController.toSelectItemFromBatchAdd();"
			...
			<div class="modal-footer">
				<button class="btn btn-outline green"
					onclick="$.WidgetItemController.batchAdd('${ctx}/widget/${widget.id}/widgetItem/batchAdd');">
