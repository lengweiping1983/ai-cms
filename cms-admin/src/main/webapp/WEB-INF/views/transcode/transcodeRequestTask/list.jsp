		...
		<div class="col-md-12">
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-globe"></i>[${transcodeRequest.name}]转码任务管理
					</div>
					<div class="actions">
						<a href="javascript:;" class="btn btn-default btn-sm"
							onclick="$.common.ajaxLoadLastContent()"> <i
							class="fa fa-reply"></i> 返回到转码工单管理
						</a>
					</div>
				</div>
				<div class="portlet-body">
					<div class="table-container">
						<div class="table-actions-wrapper-condition">
							<form
								action="${ctx}/transcode/${transcodeRequest.id}/transcodeTask/">
								<input type="hidden" name="search_requestId__EQ_L"
									value="${param.search_requestId__EQ_L}" />
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-4">
