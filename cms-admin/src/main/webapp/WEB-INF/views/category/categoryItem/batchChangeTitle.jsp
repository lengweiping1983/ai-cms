	...
	<div class="modal-dialog modal-full">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">[${category.name}]批量修改</h4>
			</div>
						...
						<div class="row">
							<div class="col-md-12">
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<c:forEach items="${categoryItemList}" var="t"
											varStatus="status">
											<tr>
			...
			<div class="modal-footer">
				<button class="btn btn-outline green"
					onclick="$.CategoryItemController.batchChangeTitle('${ctx}/category/${category.id}/categoryItem/batchChangeTitle');">
