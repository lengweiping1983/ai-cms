...
<%-- 											</c:if> --%>
										...
										<button onclick="$.AlbumItemController.toSelectItemFromBatchAdd();"
			...
			<div class="modal-footer">
				<button class="btn btn-outline green"
					onclick="$.AlbumItemController.batchAdd('${ctx}/album/${album.id}/albumItem/batchAdd');">
