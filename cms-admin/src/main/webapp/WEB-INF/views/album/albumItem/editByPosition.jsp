				...
				<c:choose>
					<c:when test="${empty albumItem.id}">
						<button class="btn btn-outline green"
							onclick="$.AlbumItemController.toDeleteByPositionBeforeNotSave();">
							<i class="fa fa-remove"></i>删除
						</button>
						<button class="btn btn-outline green"
							onclick="$.AlbumItemController.editByPosition('${ctx}/album/${album.id}/albumItem/add');">
							<i class="fa fa-save"></i>保存
						</button>
					</c:when>
					<c:otherwise>
						<button class="btn btn-outline green"
							onclick="$.AlbumItemController.toDeleteByPosition('${ctx}/album/${album.id}/albumItem/${albumItem.id}/delete','${albumItemView.itemName}');">
							<i class="fa fa-remove"></i>删除
						</button>
						<button class="btn btn-outline green"
							onclick="$.AlbumItemController.editByPosition('${ctx}/album/${album.id}/albumItem/${albumItem.id}/edit');">
							<i class="fa fa-save"></i>保存
						</button>
					</c:otherwise>
				</c:choose>
