...
<div class="table-container">
	<div class="table-actions-wrapper-condition">
		<form action="${ctx}/league/leagueSeason/selectItem" id="selectItem">
			<div class="row">
				<div class="col-md-12">
					<div class="col-md-4">
		...
		<c:forEach items="${page.content}" var="t" varStatus="status">
			<tr>
				...
				<td><a href="javascript:;"
					onclick="$.LeagueSeasonController.selectItem('${t.id}','${t.name}','${t.name}','${t.image1}','${t.image2}','${t.status}');">${t.name}</a></td>
				<td>${t.tag}</td>
				<td>${t.keyword}</td>
