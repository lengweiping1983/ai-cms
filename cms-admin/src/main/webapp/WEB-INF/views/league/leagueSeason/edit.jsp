		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">
					<c:choose>
						<c:when test="${empty leagueSeason.id}">
				...
				<c:choose>
					<c:when test="${empty leagueSeason.id}">
						<button class="btn btn-outline green"
							onclick="$.LeagueSeasonController.edit('${ctx}/league/leagueSeason/add');">
							<i class="fa fa-save"></i>保存
						</button>
					</c:when>
					<c:otherwise>
						<button class="btn btn-outline green"
							onclick="$.LeagueSeasonController.edit('${ctx}/league/leagueSeason/${leagueSeason.id}/edit');">
							<i class="fa fa-save"></i>保存
						</button>
					</c:otherwise>
				</c:choose>
