		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">
					...
					[${leagueSeason.name}]${methodDesc}赛事
				</h4>
			</div>
			<div class="modal-body">
				...
				<form id="editForm">
					<input type="hidden" name="id" value="${leagueMatch.id}" /> <input
						type="hidden" name="leagueSeasonId" id="leagueSeasonId"
				...
				<c:choose>
					<c:when test="${empty leagueMatch.id}">
						<button class="btn btn-outline green"
							onclick="$.LeagueSeasonMatchController.edit('${ctx}/league/${leagueSeason.id}/leagueMatch/add');">
							<i class="fa fa-save"></i>保存
						</button>
					</c:when>
					<c:otherwise>
						<button class="btn btn-outline green"
							onclick="$.LeagueSeasonMatchController.edit('${ctx}/league/${leagueSeason.id}/leagueMatch/${leagueMatch.id}/edit');">
							<i class="fa fa-save"></i>保存
						</button>
					</c:otherwise>
				</c:choose>
