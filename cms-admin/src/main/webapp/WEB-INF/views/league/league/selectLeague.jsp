...
<div class="table-container">
	<div class="table-actions-wrapper-condition">
		<form action="${ctx}/league/league/selectLeague" id="selectLeague">
			<div class="row">
				<div class="col-md-12">
					<div class="col-md-4">
					...
					<div class="col-md-4">
						...
						<div style="float: right">
							<button class="btn btn-default btn-sm btn-outline green"
								type="button"
								onclick="$.Page.queryByForm({containerId: 'content_list_modal_container_body', formId: 'selectLeague'});">
			...
			<c:forEach items="${page.content}" var="t">
				<tr>
					<td><a href="javascript:;"
						onclick="$.LeagueController.selectLeague('${t.id}','${t.name}','${t.name}','${t.image1}','${t.image2}','${t.status}');">${t.name}</a></td>
					<td>${t.tag}</td>
					<td>${t.area}</td>
					<td>${t.num}</td>
