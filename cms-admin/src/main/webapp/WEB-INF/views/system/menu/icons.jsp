    ...
    <div class="col-md-12">
        <div class="tabbable-line">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#tab_1_1" data-toggle="tab">图标一</a>
                </li>
                <li>
                    <a href="#tab_1_2" data-toggle="tab">图标二</a>
                </li>
                <li>
                    <a href="#tab_1_3" data-toggle="tab">图标三</a>
                </li>
            </ul>
                ...
                <div class="tab-pane active fontawesome-demo" id="tab_1_1">
                    ...
                    <section id="spinner">
                        ...
                        <div class="alert alert-success">
                            <ul class="fa-ul">
                                <li>
                                    <i class="fa fa-info-circle fa-lg fa-li"></i> These icons work great with the <code>fa-spin</code>
                    ...
                    <section id="brand">
                        ...
                        <div class="alert alert-warning">
                            ...
                            to force them to display. Please report an issue
                            with Adblock Plus if you believe this to be an error. To work around this, you'll need to
...
<script>
    $(function () {
        $(".fa-item").each(function () {
            $(this).click(function () {
                //alert($(this).children("i").attr("class"));
                var css = $(this).children("i").attr("class");
                $("#menu_icon_show").attr("class", css);
                $("#menu_icon").val(css);
                $("#menu_icon_modal_div").modal('hide');
        ...
        $('.bs-glyphicons-list li').each(function () {
            $(this).click(function () {
                //alert($(this).children("span").first().attr("class"));
                var css = $(this).children("span").first().attr("class");
                $("#menu_icon_show").attr("class", css);
                $("#menu_icon").val(css);
                $("#menu_icon_modal_div").modal('hide');
            });
