...
<div class="modal fade" id="user_edit_modal_div" role="basic"
	aria-hidden="true">
					...
					<div class="form-group">
						<form id="user_edit_form">
							...
							<div class="col-md-7">
								...
								<div class="form-group">
									<label class="col-md-4 control-label">帐号(<span
										class="required">*</span>):
									</label>
								...
								<div class="form-group">
									<label class="col-md-4 control-label">姓名(<span
										class="required">*</span>):
									</label>
							...
							<div class="portlet light bordered">
								<div class="portlet-body">
									<div class="form-group">
										...
										<div id="role_tree_div" class="tree-demo"></div>
									</div>
								</div>
							</div>
						</div>
