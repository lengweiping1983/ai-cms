        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="content form-horizontal">
                    <form id="user_profile_edit_password_form">
                        <tags:message content="${message}"/>
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="plainPassword">原密码(<span
                            ...
                            <div class="col-md-7">
                                <div class="input_tip">
                                    <input type="password"
                                           ...
                                           name="plainPassword" id="plainPassword" placeholder="原密码"/>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-outline green"
                        onclick="$.UserProfileController.editPassword('${ctx}/system/user/profile/editPassword');">
