...
<script src="${ctx}/static/scripts/system/dic-controller.js" type="text/javascript"></script>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="javascript:;" class="btn btn-default" onclick="$.DicController.toAdd()">
                            <i class="fa fa-plus"></i> 增加字典 </a>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4">
                                            <label class="control-label">
                                                字典名称:
                                                <input type="text" name="search_name__LIKE_S"
                                        ...
                                        <div class="col-md-4">
                                            <label class="control-label">
                                                字典代码:
                                                <input type="text" name="search_code__LIKE_S"
