...
<c:set var="contextPathPrefix" value="${ctx}/config/app/" />
<c:set var="permissionPrefix" value="config:app:" />
				...
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="javascript:;" class="btn btn-default btn-sm"
							onclick="$.AppController.toEdit('${contextPathPrefix}add')">
							<i class="fa fa-plus"></i>增加应用
						</a>
					</div>
				</div>
							...
							<form action="${contextPathPrefix}">
								<div class="row">
									<div class="col-md-12">
										...
										<div class="col-md-4">
											<label class="control-label">应用代码: <input type="text"
												class="form-control input-small input-inline"
										...
										<div class="col-md-4">
											<label class="control-label">应用名称: <input type="text"
					...
					<table
						...
						<thead>
							<tr>
								...
								<th class="sorting" abbr="code">应用代码</th>
								<th class="sorting" abbr="name">应用名称</th>
								...
								<tr>
									...
									<td>
										<button class="btn btn-default btn-sm btn-outline green"
											onclick="$.AppController.toEdit('${contextPathPrefix}${t.id}/edit',${t.id});">
											<i class="fa fa-edit"></i>修改
										</button> <c:forEach var="item" items="${statusEnum}">
											<c:if test="${item.key eq t.status && item.key eq 0}">
												<button class="btn btn-default btn-sm btn-outline green"
													onclick="$.AppController.toDelete('${contextPathPrefix}${t.id}/delete','${t.name}');">
...
<script>
$.AppController.keypress({containerId: '${containerId}', formId: '${formId}'});
</script>
