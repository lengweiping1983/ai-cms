...
<div class="table-container">
	<div class="table-actions-wrapper-condition">
		<form action="${ctx}/live/schedule/selectItem" id="selectItem">
			<div class="row">
				<div class="col-md-12">
					<div class="col-md-4">
			...
			<c:forEach items="${page.content}" var="t">
				<tr>
					<td><a href="javascript:;"
						onclick="$.ScheduleController.selectItem('${t.id}','${t.programName}','${t.programName}','','','${t.status}');">${t.channel.code}</a></td>
					<td><a href="javascript:;"
						onclick="$.ScheduleController.selectItem('${t.id}','${t.programName}','${t.programName}','','','${t.status}');">${t.channel.name}</a></td>
					<td><a href="javascript:;"
						onclick="$.ScheduleController.selectItem('${t.id}','${t.programName}','${t.programName}','','','${t.status}');">${t.programName}</a></td>
