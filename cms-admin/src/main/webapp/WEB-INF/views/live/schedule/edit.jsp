									...
									<div class="col-md-9">
										<div class="input-group">
											<input type="hidden" id="channelType" value="${channel.type}"
												onchange="$.ScheduleController.changeChannelType(this.value);" />
				...
				<c:choose>
					<c:when test="${empty schedule.id}">
						<button class="btn btn-outline green"
							onclick="$.ScheduleController.edit('${ctx}/live/schedule/add');">
							<i class="fa fa-save"></i>保存
						</button>
					</c:when>
					<c:otherwise>
						<button class="btn btn-outline green"
							onclick="$.ScheduleController.edit('${ctx}/live/schedule/${schedule.id}/edit');">
							<i class="fa fa-save"></i>保存
						</button>
					</c:otherwise>
				</c:choose>
