...
<div class="table-container">
	<div class="table-actions-wrapper-condition">
		<form action="${ctx}/live/channel/selectItem" id="selectItem">
			<div class="row">
				<div class="col-md-12">
					<div class="col-md-4">
			...
			<c:forEach items="${page.content}" var="t">
				<tr>
					...
					<td><a href="javascript:;"
						onclick="$.ChannelController.selectItem('${t.id}','${t.name}','${t.name}','${t.image1}','${t.image2}','${t.status}');">${t.code}</a></td>
					<td><a href="javascript:;"
						onclick="$.ChannelController.selectItem('${t.id}','${t.name}','${t.name}','${t.image1}','${t.image2}','${t.status}');">${t.name}</a></td>
