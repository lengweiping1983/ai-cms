		...
		<div class="col-md-12">
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-globe"></i>[${series.name}]节目管理
					</div>
					<div class="actions">
						<div class="actions">
							<shiro:hasPermission name="${permissionPrefix}add">
								<a href="javascript:;" class="btn btn-default btn-sm"
									onclick="$.ProgramController.toEdit('${contextPathPrefix}add?seriesId=${series.id}')">
				...
				<div class="portlet-body">
					<div class="table-container">
						<div class="table-actions-wrapper-condition">
							<form action="${contextPathPrefix}listBySeriesId">
							...
							<c:forEach items="${page.content}" var="t" varStatus="status">
								<tr>
									...
									<td><c:if test="${t.status eq 0 || t.status eq 2}">
										...
										<shiro:hasPermission name="${permissionPrefix}playCode">
											<button class="btn btn-default btn-sm btn-outline green"
