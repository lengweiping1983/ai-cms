...
<c:set var="contextPathPrefix" value="${ctx}/media/mediaFile/" />
<c:set var="permissionPrefix" value="media:mediaFile:" />
								...
								<tr>
									...
									<td><c:if test="${t.status eq 0 || t.status eq 2}">
										...
										<button class="btn btn-default btn-sm btn-outline green"
											...
											onclick="$.PlayController.toPreviewMediaFile('${t.id}'); return false;">
											<i class="fa fa-eye"></i>预览
										</button> <shiro:hasPermission name="${permissionPrefix}playCode">
											<button class="btn btn-default btn-sm btn-outline green"
												onclick="$.MediaFileController.toPlayCode('${contextPathPrefix}${t.id}/playCode',${t.id});">
