...
-- ----------------------------
--  Table structure for `cms_cp_ftp`
-- ----------------------------
DROP TABLE IF EXISTS `cms_cp_ftp`;
CREATE TABLE `cms_cp_ftp` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
...
CREATE TABLE `cms_media_program` (
  ...
  `type` int(11) DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `FK_m3chxntci4jk95pmejnh49owj` (`series_id`),
...
-- ----------------------------
--  Records of `cms_media_template`
-- ----------------------------
BEGIN;
INSERT INTO `cms_media_template` VALUES ('-1', '2018-04-20 08:12:15', '2018-04-20 08:14:13', '128', 'AAC', 'default', 'UNKNOWN', 'HD', '', 'TS-VBR-H264-0-720P-25-AAC-128', '1', '未知', '1', '0', '0', 'VBR', 'H264', 'TS', '25', null, '0', '0', null, null, '720P'), ('2', '2018-04-20 08:15:12', null, '128', 'AAC', 'default', '8M_VBR', 'HD', '', 'TS-VBR-H264-8000-1080P-25-AAC-128', '1', '8M_VBR', '1', '0', '8000', 'VBR', 'H264', 'TS', '25', null, '8000', '8000', null, null, '1080P');
COMMIT;
