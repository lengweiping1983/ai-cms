...
public enum ContentTypeEnum {
	...
	public static List<ContentTypeEnum> toList() {
		...
		if (AppGlobal.getProfiles().contains("jsydnews")) {
			enumList.add(ContentTypeEnum.NEWS);
			enumList.add(ContentTypeEnum.FINANCE);
			enumList.add(ContentTypeEnum.MILITARY);
			enumList.add(ContentTypeEnum.HEALTHY);
			enumList.add(ContentTypeEnum.EAGLE_EYE);
			enumList.add(ContentTypeEnum.JISHI);
			ContentTypeEnum.MUSIC.setValue("音频");
			enumList.add(ContentTypeEnum.MUSIC);
			return enumList;
		}
