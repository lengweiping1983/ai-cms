...
//public class GenCategoryItemService extends GenCommonService {
//
//	/**
//	 * 生成栏目项任务，同时需要合并栏目项相关事件
//	 * 
//	 * @param sendEvent
//	 * @param category
//	 * @param priority
...
//	public SendTask genCategoryItemTask(SendEvent sendEvent, Category category) {
//		// 1. 生成任务
...
//
//		sendTask.setName(sendEvent.getItemName() + " " + "编排" + " "
...
//							InjectionItemTypeEnum.CATEGORY.getKey(),
...
//			MappingBean mappingBean = genCategoryItemMappingBean(objectEvent);
...
//	 * @return
//	 */
//	public MappingBean genCategoryItemMappingBean(SendEvent sendEvent) {
