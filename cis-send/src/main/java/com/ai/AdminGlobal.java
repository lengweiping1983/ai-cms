...
public class AdminGlobal {
	...
	@Value("${injection.accessIP:}")
	public void setAccessIP(String accessIP) {
		AdminGlobal.accessIP = accessIP;
	}

	public static boolean changeWorkingDirectory;

	public static boolean isChangeWorkingDirectory() {
		return changeWorkingDirectory;
	}

	@Value("${injection.ftp.changeWorkingDirectory:false}")
	public void setChangeWorkingDirectory(boolean changeWorkingDirectory) {
		AdminGlobal.changeWorkingDirectory = changeWorkingDirectory;
	}
