...
public class CSPResponseServiceLocator extends org.apache.axis.client.Service implements iptv.CSPResponseService {
    ...
    public iptv.CSPResponse getctms() throws javax.xml.rpc.ServiceException {
    ...
    public iptv.CSPResponse getctms(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (iptv.CSPResponse.class.isAssignableFrom(serviceEndpointInterface)) {
